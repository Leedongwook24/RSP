...
<title>RSP-Result4</title>
</head>
<body>
<div class="totalbox"> 
		<header class="title"> 4人ジャンケン結果</header>
		<% 
			...
			String computer3 = (String) request.getAttribute("computer3");			
			...
			int computer3_int= Integer.parseInt(computer3);
		%>
			<div class="mainbox">
				<div class="resultbox">
				<table class="result_table">
					...
					<tr>
						...
						<td><img src="/RSP/images/RSP<%= computer3_int%>.png" alt=user_result_image class="user_image"></td>					
					</tr>
					<tr>
						<td class="user_name_smaller">Cpu</td>
						<td class="user_name_smaller">Cpu3</td>
					</tr>
					
				</table>
				</div>
				<div class="button-case">
				<form id="winlose" action="Four" metod=Post">
